...
$route['v1/products'] = "api/products";
...
//ipay88 related
//checkout_payment_ipay88
$route['checkout_payment_ipay88/(:num)'] = "ipay88/checkout_payment_ipay88/$1";
$route['checkout_completed_ipay88/(:num)'] = "ipay88/checkout_completed_ipay88/$1";
$route['checkout_callback_ipay88'] = "ipay88/checkout_callback_ipay88";
$route['checkout_retry_ipay88/(:num)'] = "ipay88/checkout_retry_ipay88/$1";

//RMS related
$route['checkout_payment_rms/(:num)'] = "rms/checkout_payment_rms/$1";
$route['checkout_retry_rms/(:num)'] = "rms/checkout_retry_rms/$1";
$route['checkout_callback_rms'] = "rms/checkout_callback_rms";
$route['checkout_completed_rms/(:num)'] = "rms/checkout_completed_rms/$1";
